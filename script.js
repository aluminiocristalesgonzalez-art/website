...
const waMessage = `Hola, soy [TU NOMBRE].

Me gustaría una cotización de cancelería de aluminio / cristales:
- Tipo: (puerta / ventana / portón / cancel de baño / vitrina / cristal)
- Medidas aproximadas (ancho x alto):
- Ubicación/colonia:

Puedo enviar fotos. ¿Me puedes cotizar? Gracias.`;
